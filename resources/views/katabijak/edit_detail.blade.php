            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="setting-form" method="POST"
                        action="{{ route('katabijakdetail.update', [$katas->id, $data->id]) }}"
                        ...
                        <div class="card" id="settings-card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row align-items-center">
                                    <label for="site-title" class="form-control-label col-sm-3 text-md-right">Penjelasan
                                    </label>
                                    <div class="col-sm-6 col-md-9">


                                        <textarea class="form-control" style=" min-width:500px; max-width:100%;min-height:50px;height:100%;width:100%;"
                                            name="penjelasan" required rows="5"
                                            cols="50">{{ old('penjelasan') != null ? old('penjelasan') : $data->penjelasan }}</textarea>
                                        @error('penjelasan')
