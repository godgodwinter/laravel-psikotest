        ...
        <section class="section">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('profile.siswa.update') }}" method="post">
                        @method('put')
                        @csrf
                        ...
                        <div class="form-group col-md-5 col-5 mt-0 ml-5">
                            ...
                            <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{$datas->name}}" required readonly>
