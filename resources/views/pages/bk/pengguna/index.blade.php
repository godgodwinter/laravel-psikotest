        ...
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="ml-auto p-2 bd-highlight">
                        ...
                        <a href="{{route('bk.pengguna.create',$id->id)}}" type="submit" value="Import"
                    ...
                    @forelse ($datas as $data)
                            <tr id="sid{{ $data->id }}">
                                    ...
                                    <td class="text-center babeng-min-row">
                                        ...
                                        <x-button-edit link="{{ route('bk.pengguna.edit',[$data->id])}}" />
                                        <x-button-delete link="{{ route('bk.pengguna.destroy',[$data->id])}}" />
                                    </td>
