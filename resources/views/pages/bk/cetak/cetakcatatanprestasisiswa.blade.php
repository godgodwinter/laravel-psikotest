...
<body>
    ...
    <div style="margin-bottom: 0;text-align:center" id="judul">
        <h2>REKAP CATATAN PRESTASI SISWA</h2>
        <p for=""></p>
    </div>
    ...
    <table width="100%" id="tableBiasa">
        <tr>
            ...
            <th align="center">Teknik Belajar</th>
            <th align="center">Sarana Belajar</th>
            <th align="center">Penunjang Belajar</th>
            <th align="center">Kesimpulan dan Saran</th>
        ...
        <tr>
            ...
            <td align="center"> {{$data->prestasi}}</td>
            <td align="center"> {{$data->teknikbelajar}}</td>
            <td align="center"> {{$data->saranabelajar}}</td>
            <td align="center"> {{$data->penunjangbelajar}}</td>
            <td align="center"> {{$data->kesimpulandansaran}}</td>
        </tr>
