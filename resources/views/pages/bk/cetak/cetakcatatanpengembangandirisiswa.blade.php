...
<body>
    ...
    <table width="100%" id="tableBiasa">
        <tr>
            ...
            <th align="center">Ide dan Imajinasi</th>
            <th align="center">Keterampilan</th>
            <th align="center">Kreatif</th>
            <th align="center">Organisasi</th>
            <th align="center">Kelanjutan Studi</th>
            <th align="center">Hobi</th>
            <th align="center">Cita - cita</th>
            <th align="center">Kemapuan Khusus</th>
        ...
        <tr>
            ...
            <td align="center"> {{$data->idedanimajinasi}}</td>
            <td align="center"> {{$data->ketrampilan}}</td>
            <td align="center"> {{$data->kreatif}}</td>
            <td align="center"> {{$data->organisasi}}</td>
            <td align="center"> {{$data->kelanjutanstudi}}</td>
            <td align="center"> {{$data->hobi}}</td>
            <td align="center"> {{$data->citacita}}</td>
            <td align="center"> {{$data->kemampuankhusus}}</td>
