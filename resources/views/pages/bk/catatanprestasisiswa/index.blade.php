...
<section class="section">
 ...
 <form action="{{route('bk.catatanprestasisiswa.cari')}}" method="GET" class="babeng-form">
    <div class="row mb-2">
                ...
                <tr id="sid{{ $data->id }}">
                        ...
                        <td class="text-center">
                         ...
                         <td class="text-center">
                            ...
                            <a class="btn btn-sm btn-light px-3" href="{{ route('bk.catatanprestasisiswa.detail',[$data->id])}}"> {{$data->jmldata}}</a>
                        ...
                        <a href="{{route('bk.catatanprestasisiswa.create',['siswa_id'=>$data->id])}}" type="submit" value="Import"
                            ...
                            {{-- <x-button-edit link="{{ route('bk.catatanprestasisiswa.edit',[$id->id,$data->id])}}" /> --}}
                            {{-- <x-button-delete link="{{ route('bk.catatanprestasisiswa.destroy',[$id->id,$data->id])}}" /> --}}
                        </td>
                    </tr>
        @empty
                    <tr>
...
<div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      {{-- <form method="post" action="{{ route('bk.catatanprestasisiswa.import',$id->id) }}" enctype="multipart/form-data"> --}}
