                      ...
                      <div class="card-body">
                          ...
                          <div class="form-group row align-items-center">
                            ...
                            <div class="col-sm-6 col-md-9">
                                ...
                                <textarea  class="form-control" style=" min-width:500px; max-width:100%;min-height:50px;height:100%;width:100%;" name="kesimpulandansaran" required rows="5" cols="50">{{old('kesimpulandansaran')}}</textarea>
