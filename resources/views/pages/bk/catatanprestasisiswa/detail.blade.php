...
<section class="section">
    <div class="section-header">
        ...
        {{-- <a href="{{ route('bk.catatanprestasisiswa.export') }}" type="submit" value="Import"
...
<div class="modal-dialog" role="document">
  {{-- <form method="post" action="{{ route('bk.catatanprestasisiswa.import') }}" enctype="multipart/form-data"> --}}
