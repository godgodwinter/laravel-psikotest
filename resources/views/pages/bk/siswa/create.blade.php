    ...
    <div class="section-body">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="setting-form" method="POST" action="{{route('bk.siswa.store',$id->id)}}">
                    @csrf
                        ...
                        <div class="card-body">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab"
                                        aria-controls="home" aria-selected="true">Identitas Pribadi2</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                    ...
                                    <div class="form-group row align-items-center">
                                        <label for="site-title"
                                            class="form-control-label col-sm-3 text-md-right">Kewarganegaraan</label>
                                        <div class="col-sm-6 col-md-9">
                                    ...
                                    <div class="form-group row align-items-center">
                                        <label for="site-title" class="form-control-label col-sm-3 text-md-right">Jarak Ke
                                            Sekolah</label>
                                        <div class="col-sm-6 col-md-9">
                                ...
                                <div class="tab-pane fade" id="kesehatan" role="tabpanel" aria-labelledby="kesehatan-tab">
                                    ...
                                    <div class="form-group row align-items-center">
                                        <label for="site-title" class="form-control-label col-sm-3 text-md-right">Kelainan
                                            Jasmani</label>
                                        <div class="col-sm-6 col-md-9">
                                ...
                                <div class="tab-pane fade" id="orangtua" role="tabpanel" aria-labelledby="orangtua-tab">
                                    <div class="form-group row align-items-center">
                                        <label for="site-title" class="form-control-label col-sm-3 text-md-right">Nama Ayah
                                            Kandung</label>
                                        <div class="col-sm-6 col-md-9">
                                    ...
                                    <div class="form-group row align-items-center">
                                        <label for="site-title" class="form-control-label col-sm-3 text-md-right">Tempat Lahir
                                            Ayah</label>
                                        <div class="col-sm-6 col-md-9">
                                    ...
                                    <div class="form-group row align-items-center">
                                        <label for="site-title" class="form-control-label col-sm-3 text-md-right">Tanggal Lahir
                                            Ayah</label>
                                        <div class="col-sm-6 col-md-9">
                                            <div class="form-group">
                                    ...
                                    <div class="form-group row align-items-center">
                                        <label for="site-title" class="form-control-label col-sm-3 text-md-right">Pendidikan
                                            Ayah</label>
                                        <div class="col-sm-6 col-md-9">
                                    ...
                                    <div class="form-group row align-items-center">
                                        <label for="site-title" class="form-control-label col-sm-3 text-md-right">Penghasilan
                                            Ayah</label>
                                        <div class="col-sm-6 col-md-9">
                                    ...
                                    <div class="form-group row align-items-center">
                                        <label for="site-title" class="form-control-label col-sm-3 text-md-right">Nama Ibu
                                            Kandung</label>
                                        <div class="col-sm-6 col-md-9">
