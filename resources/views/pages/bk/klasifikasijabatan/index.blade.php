                ...
                <table id="example" class="table table-striped table-bordered mt-1 table-sm" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr id="sid{{ $data->id }}">
                                ...
                                <td>
                                    <a href="{{ route('bk.klasifikasijabatan.detail',$data->id)}}" class="btn btn-icon btn-info btn-sm ml-1"  data-toggle="tooltip" data-placement="top" title="Lihat data!"><i class="fas fa-angle-double-right"></i></a>
                                </td>
