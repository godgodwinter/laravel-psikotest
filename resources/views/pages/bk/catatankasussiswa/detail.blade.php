...
<section class="section">
    <div class="section-header">
        ...
        {{-- <a href="{{ route('bk.catatankasussiswa.export') }}" type="submit" value="Import"
        ...
        <tbody>
            ...
            <tr id="sid{{ $data->id }}">
                    ...
                    <td class="text-center babeng-min-row">
                        {{-- <a class="btn btn-sm btn-info" href="{{ route('bk.catatankasussiswa.cetakpersiswa',[$data->id])}}"><i class="fas fa-print"></i></a> --}}
...
<div class="modal-dialog" role="document">
  {{-- <form method="post" action="{{ route('bk.catatankasussiswa.import') }}" enctype="multipart/form-data"> --}}
