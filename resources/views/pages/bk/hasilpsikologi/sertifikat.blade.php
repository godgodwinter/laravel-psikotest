    ...
    <div class="col-md-9">
        @push('before-script')
            ...
            (async()=>{
                ...
                const response = await fetch("{{route('bk.hasilpsikologi.sertifikat_lihatapi',[$datasiswa->id])}}", requestOptions);
