        ...
        <table id="example" class="table table-striped table-bordered mt-1 table-sm" >
            ...
            <tbody>
                ...
                <tr id="sid{{ $loop->index+1 }}">
                    ...
                    <td class="text-center">
                        <a class="btn btn-sm btn-info" href="{{route('bk.hasilpsikologi.deteksi_lihat',[$data->id])}}"> Lihat Deteksi</a>
                    </td>
                    <td class="text-center">
                        <a class="btn btn-sm btn-info" href="{{route('bk.hasilpsikologi.sertifikat_lihat',[$data->id])}}"> Lihat Sertifikat</a>
