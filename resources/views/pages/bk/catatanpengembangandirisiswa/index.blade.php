...
<section class="section">
 ...
 <form action="{{route('bk.catatanpengembangandirisiswa.cari')}}" method="GET" class="babeng-form">
    <div class="row mb-2">
                ...
                <tr id="sid{{ $data->id }}">
                        ...
                        <td class="text-center">
                         ...
                         <td class="text-center">
                            ...
                            <a class="btn btn-sm btn-light px-3" href="{{ route('bk.catatanpengembangandirisiswa.detail',[$data->id])}}"> {{$data->jmldata}}</a>

                         </td>

                        <td class="text-center babeng-min-row">
                            <a class="btn btn-sm btn-info" href="{{ route('sekolah.catatanpengembangandiri.cetakpersiswa',[$sekolah_id,$data->id])}}"><i class="fas fa-print"></i></a>

                        <a href="{{route('bk.catatanpengembangandirisiswa.create',['siswa_id'=>$data->id])}}" type="submit" value="Import"
                            class="btn btn-icon btn-primary btn-sm ml-2"><span class="pcoded-micon"> <i
                                    class="fas fa-plus"></i>  </span></a>
                            {{-- <x-button-edit link="{{ route('bk.catatanpengembangandirisiswa.edit',[$id->id,$data->id])}}" /> --}}
                            {{-- <x-button-delete link="{{ route('bk.catatanpengembangandirisiswa.destroy',[$id->id,$data->id])}}" /> --}}
                        </td>
                    </tr>
        @empty
                    <tr>
...
<div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      {{-- <form method="post" action="{{ route('bk.catatanpengembangandirisiswa.import',$id->id) }}" enctype="multipart/form-data"> --}}
