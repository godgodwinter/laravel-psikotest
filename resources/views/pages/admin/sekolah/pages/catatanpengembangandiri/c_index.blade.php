 ...
 <form action="{{route('sekolah.catatanpengembangandiri.cari',$id->id)}}" method="GET" class="babeng-form">
    <div class="row mb-2">
                ...
                <tr id="sid{{ $data->id }}">
                        ...
                        <td class="text-center">
                         ...
                         <td class="text-center">
                            ...
                            <a class="btn btn-sm btn-light px-3" href="{{ route('sekolah.catatanpengembangandiri.detail',[$id->id,$data->id])}}"> {{$data->jmldata}}</a>
                        ...
                        <td class="text-center babeng-min-row">
                            ...
                            <a href="{{route('sekolah.catatanpengembangandiri.create',[$id->id,'siswa_id'=>$data->id])}}" type="submit" value="Import"
                                class="btn btn-icon btn-primary btn-sm ml-2"><span class="pcoded-micon"> <i
