    ...
    <section class="section">
                ...
                @push('before-script')
                    <script>
                        ...
                        function setData(datas = null) {
                            ...
                            let iq_persenString =
                                `<div width="100%">IV. IQ (KM) 8 Kecerdasan </div><div> ${dataSertifikat.iq_persen} % </div> <div>Keterangan :  <b>${kepanjangan(dataSertifikat.iqh)}</b></div>`;
                            ...
                            document.getElementById('minat_pekerjaan_1').innerText = '- ' + dataSertifikat.minat_pekerjaan_1 + ' ' +
                                dataSertifikat.minat_pekerjaan_1_persen;
                            document.getElementById('minat_pekerjaan_2').innerText = '- ' + dataSertifikat.minat_pekerjaan_2 + ' ' +
                                dataSertifikat.minat_pekerjaan_2_persen;
                            document.getElementById('minat_pekerjaan_3').innerText = '- ' + dataSertifikat.minat_pekerjaan_3 + ' ' +
                                dataSertifikat.minat_pekerjaan_3_persen;
        ...
        <tr>
           ...
           ${silang}
                            ...
                            kesimpulansekolahlanjutan =
                                `Kelanjutan studi disarankan masuk Fakultas <b> ${dataSertifikat.saran_fakultas_1} </b> dengan Prodi <b> ${dataSertifikat.saran_fakultas_1_prodi}</b>, Fakultas <b> ${dataSertifikat.saran_fakultas_2} </b> dengan Prodi <b> ${dataSertifikat.saran_fakultas_2_prodi}</b>.`;
                            let isKelas9 = '{{ $iskelas9 }}';
                            if (isKelas9 == 'ya') {
                                kesimpulansekolahlanjutan =
                                    `Kelanjutan studi disarankan masuk Sekolah <b> ${dataSertifikat.saran_fakultas_1} </b> dengan Jurusan <b> ${dataSertifikat.saran_fakultas_1_prodi}</b>, Sekolah <b> ${dataSertifikat.saran_fakultas_2} </b> dengan Jurusan <b> ${dataSertifikat.saran_fakultas_2_prodi}</b>.`;
                            }
          ...
          <td> </td><td>  </td><td>  </td>`;
                ...
                <div class="card" id="settings-card">
                    ...
                    <div class="card-body babengcontainer">
                        ...
                        <table border="0" width="60%">
                            <tr>
                                <td>I. IQ (Intelegence Quotient) / IST </td>
                                <td>:</td>
                                <td id="iq"></td>
                                <td>/</td>
                                <td id="iqket"></td>
                            ...
                            <tr>
                                <td>II. EQ (Emotional Quotient) </td>
                                <td>:</td>
                                <td id="eq_persen"></td>
                                <td>/</td>
                                <td id="eq_persen_keterangan"></td>
                            </tr>
                            <tr>
                                <td>III. Sc.Q (Social Quotient) </td>
                                <td>:</td>
                                <td id="scq_persen"></td>
                                <td>/</td>
                                <td id="scq_persen_keterangan"></td>
                            </tr>
                        </table>

                        <table border="1" width="100%" id="kecerdasanTable"
                            class="table table-striped table-bordered mt-1 table-sm">
                            <tr>
                                <td id="iq_persen" class="babeng-min-row">IV. IQ (KM) 8 Kecerdasan </td>
                                <td>Rank Nilai</td>
                                <td>Sangat Kurang Sekali</td>
                                <td>Kurang Sekali</td>
                                <td>Kurang</td>
                                <td>Hampir Cukup</td>
                                <td>Cukup</td>
                        ...
                        <table border="1" width="100%" id="kepribadianTable"
                            ...
                            <tr>
                                <td id="tipe_bakat_1">-</td>
                            </tr>
                            <tr>
                                <td id="tipe_bakat_2">-</td>
                            </tr>
                            <tr>
                                <td id="tipe_bakat_3">-</td>
                            </tr>
                        </table>
                        ...
                        <table border="1" width="100%" id="kepribadianTable"
                            ...
                            <tr>
                                <td id="minat_pekerjaan_1">-</td>
                            </tr>
                            <tr>
                                <td id="minat_pekerjaan_2">-</td>
                            </tr>
                            <tr>
                                <td id="minat_pekerjaan_3">-</td>
                            </tr>
                        </table>
