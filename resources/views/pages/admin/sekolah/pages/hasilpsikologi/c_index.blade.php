<form action="{{ route('sekolah.hasilpsikologi.cari', $id->id) }}" method="GET" class="babeng-form">
    <div class="row mb-2">
        ...
        <div class="col-6 col-md-3 col-sm-4">
            ...
            <select class="js-example-basic-single  form-control @error('kelas_id') is-invalid @enderror" name="kelas_id"
                style="width: 75%" style="width: 100%" required>
        ...
        <div class="col-12 col-md-6 col-sm-4  text-right">
            <a href="{{ route('sekolah.hasilpsikologi.create', $id->id) }}" type="submit" value="Import"
                class="btn btn-icon btn-primary btn-sm ml-2"><span class="pcoded-micon"> <i class="fas fa-download"></i>
                    Tambah </span></a>
                    ...
                    <tr id="sid{{ $loop->index + 1 }}">
                        ...
                        <td class="text-center">
                            <a class="btn btn-sm btn-info"
                                href="{{ route('sekolah.hasilpsikologi.deteksi_lihat', [$id->id, $data->id]) }}">
                                Lihat
                                Deteksi</a>
                        </td>
                        <td class="text-center">
                        ...
                        <td class="text-center">
                            <a class="btn btn-sm btn-info"
                                href="{{ route('sekolah.hasilpsikologi.sertifikat_lihat', [$id->id, $data->id]) }}">
                                Lihat Sertifikat</a>
                        ...
                        <td class="text-center babeng-min-row">
                            <x-button-edit
                                link="{{ route('sekolah.hasilpsikologi.create', $id->id) }}?siswa_id={{ $data->id }}" />
                            <x-button-delete
                                link="{{ route('sekolah.hasilpsikologi.destroy', [$id, $data->id]) }}" />
...
@section('containermodal')
    ...
    <div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <form method="post" action="{{ route('sekolah.hasilpsikologi.import', $id->id) }}"
