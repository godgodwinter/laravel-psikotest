                  ...
                  <div class="card-body">
                    <div id="babeng-bar" class="text-right mt-2">
                        ...
                        <div id="babeng-row ">
                            ...
                            <form action="{{route('sekolah.masternilaipsikologi.cari',$id->id)}}" method="GET">
                                ...
                                <a href="{{route('sekolah.masternilaipsikologi.create',$id->id)}}" type="submit" value="Import"
            ...
            <table id="example" class="table table-striped table-bordered mt-1" style="width:100%">
                ...
                @forelse ($datas as $data)
                        <tr id="sid{{ $data->id }}">
                                ...
                                <td>
                                    {{$data->singkatan}}
                                    {{-- {{$data->walimasternilaipsikologi->nama}} --}}
                                </td>

                                <td class="text-center">
                                    {{-- <x-button-reset-pass link="/admin/{{ $pages }}/{{$data->id}}/reset" /> --}}
                                    <x-button-edit link="{{ route('sekolah.masternilaipsikologi.edit',[$id->id,$data->id])}}" />
                                    <x-button-delete link="{{ route('sekolah.masternilaipsikologi.edit',[$id->id,$data->id])}}" />
                                </td>
                            </tr>
                @empty
                            <tr>
