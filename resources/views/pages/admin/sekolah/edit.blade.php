            ...
            <div class="card-body">
                ...
                <form action="{{route('sekolah.update',$id->id)}}" method="post">
                    ...
                    <div class="form-group col-md-5 col-5 mt-0 ml-5">
                        ...
                        <input type="text" name="alamat" id="alamat" class="form-control @error('alamat') is-invalid @enderror" value="{{old('alamat') ? old('alamat') : $id->alamat}}" >
                    ...
                    <div class="form-group col-md-5 col-5 mt-0 ml-5">
                        ...
                        <select class="form-control  @error('status') is-invalid @enderror" name="status" required>
                            ...
                            <option>{{old('status') ? old('status') : $id->status}}</option>
                            <option>Aktif</option>
                    ...
                    <div class="form-group col-md-5 col-5 mt-0 ml-5">
                        ...
                        <input type="text" name="kepsek_nama" id="kepsek_nama" class="form-control @error('kepsek_nama') is-invalid @enderror" value="{{old('kepsek_nama')?old('kepsek_nama'):$id->kepsek_nama}}" >
                    ...
                    <div class="form-group col-md-5 col-5 mt-0 ml-5">
                        ...
                        <input type="text" name="tahunajaran_nama" id="tahunajaran_nama" class="form-control @error('tahunajaran_nama') is-invalid @enderror" value="{{old('tahunajaran_nama')?old('tahunajaran_nama'):$id->tahunajaran_nama}}" >
                    ...
                    <div class="form-group col-md-5 col-5 mt-0 ml-5">
                        ...
                        <input type="text" name="semester_nama" id="kepsek_nama" class="form-control @error('semester_nama') is-invalid @enderror" value="{{old('semester_nama')?old('semester_nama'):$id->semester_nama}}" >
