...
@section('content')
        <section class="section">
            ...
            <div class="card">
                <div class="card-body">
                    <form id="setting-form" method="POST" action="{{route('dashboard.siswa.store')}}">
                        @method('put')
                        @csrf
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        ...
                                        <div class="form-group row align-items-center">
                                            ...
                                            <div class="col-sm-6 col-md-9">
                                                ...
                                                <input type="text" class="form-control  @error('nama') is-invalid @enderror" name="nama"
                                                    required value="{{old('nama') ? old('nama') : $data->nama}}" readonly>
                                        ...
                                        <div class="form-group row align-items-center">
                                            ...
                                            <input type="text" class="form-control  @error('kelasnama') is-invalid @enderror"
                                            value="{{$data->kelas?$data->kelas->nama:'Data tidak ditemukan'}}"
                                            name="kelasnama" readonly>
                                  ...
                                  <script type="text/javascript">
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col-sm-6 col-md-9">
                                            ...
                                            <input type="text" class="form-control  @error('sekolahnama') is-invalid @enderror"
                                                value="{{$data->sekolah?$data->sekolah->nama:' '}}"
                                                name="sekolahnama" readonly>
