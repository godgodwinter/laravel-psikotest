            ...
            <div class="card" id="settings-card">
              ...
              <div class="card-body">
                ...
                <div class="form-group row align-items-center">
                    <label for="site-title" class="form-control-label col-sm-3 text-md-right">Nama Yayasan</label>
                  ...
                  <div class="form-group row align-items-center">
                      ...
                      <div class="col-sm-6 col-md-9">
                        ...
                        <input type="text" class="form-control  @error('kepala') is-invalid @enderror" name="kepala" required  value="{{old('kepala')}}">
                  ...
                  <div class="form-group row align-items-center">
                    ...
                    <div class="col-sm-6 col-md-9">
                      ...
                      <input type="text" class="form-control  @error('alamat') is-invalid @enderror" name="alamat" required  value="{{old('alamat')}}">
                  ...
                  <div class="form-group row align-items-center">
                    ...
                    <div class="col-sm-6 col-md-9">
                      ...
                      <input type="text" class="form-control  @error('telp') is-invalid @enderror" name="telp" required  value="{{old('telp')}}">
