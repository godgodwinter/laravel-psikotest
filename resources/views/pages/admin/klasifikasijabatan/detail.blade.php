              ...
              <div class="card-body">
                ...
                <div class="form-group row align-items-center">
                    ...
                    <div class="col-sm-6 col-md-9">
                      ...
                      <input type="text" class="form-control  @error('bidang') is-invalid @enderror" name="bidang" readonly  value="{{old('bidang')!=null ? old('bidang') : $data->bidang}}">
                ...
                <div class="form-group row align-items-center">
                    ...
                    <div class="col-sm-6 col-md-9">
                      ...
                      <input type="text" class="form-control  @error('pekerjaan') is-invalid @enderror" name="akademis" readonly  value="{{old('akademis')!=null?old('akademis'):$data->akademis}}">
                ...
                <div class="form-group row align-items-center">
                    ...
                    <div class="col-sm-6 col-md-9">
                      ...
                      <input type="text" class="form-control  @error('pekerjaan') is-invalid @enderror" name="pekerjaan" readonly  value="{{old('pekerjaan')!=null?old('pekerjaan'):$data->pekerjaan}}">
                ...
                <div class="form-group row align-items-center">
                    ...
                    <div class="col-sm-6 col-md-9">
                      ...
                      <input type="text" class="form-control  @error('nilaistandart') is-invalid @enderror" name="nilaistandart" readonly  value="{{old('nilaistandart')!=null?old('nilaistandart'):$data->nilaistandart}}">
                ...
                <div class="form-group row align-items-center">
                    ...
                    <div class="col-sm-6 col-md-9">
                      ...
                      <input type="text" class="form-control  @error('iqstandart') is-invalid @enderror" name="iqstandart" readonly  value="{{old('iqstandart')!=null?old('iqstandart'):$data->iqstandart}}">
                ...
                <div class="form-group row align-items-center">
                    ...
                    <div class="col-sm-6 col-md-9">
                      ...
                      <input type="text" class="form-control  @error('jurusan') is-invalid @enderror" name="jurusan" readonly  value="{{old('jurusan')!=null?old('jurusan'):$data->jurusan}}">
                ...
                <div class="form-group row align-items-center">
                    ...
                    <div class="col-sm-6 col-md-9">
                      ...
                      <textarea  class="form-control" style=" min-width:500px; max-width:100%;min-height:50px;height:100%;width:100%;" name="bidangstudi" readonly rows="5" cols="50">{{old('bidangstudi')!=null?old('bidangstudi'):$data->bidangstudi}}</textarea>
                ...
                <div class="form-group row align-items-center">
                    ...
                    <div class="col-sm-6 col-md-9">
                      ...
                      <input type="text" class="form-control  @error('ket') is-invalid @enderror" name="ket" readonly  value="{{old('ket')!=null?old('ket'):$data->ket}}">
