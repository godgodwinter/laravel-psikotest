                ...
                <div class="card-body">
                    ...
                    <div class="d-flex bd-highlight mb-0 align-items-center">
                        ...
                        <div class="p-2 bd-highlight">
                            ...
                            <form action="{{ route('penjelasanfaktorkepribadian.cari') }}" method="GET">
                        ...
                        <div class="ml-auto p-2 bd-highlight">
                            <a href="{{ route('penjelasanfaktorkepribadian.create') }}" type="submit" value="Import"
                    ...
                    <x-jsmultidel link="{{ route('penjelasanfaktorkepribadian.multidel') }}" />
                    @if ($datas->count() > 0)
                        <x-jsdatatable />
                    @endif
                            ...
                            @forelse ($datas as $data)
                                <tr id="sid{{ $data->id }}">
                                    ...
                                    <td class="text-center babeng-min-row">
                                        ...
                                        <x-button-edit
                                            link="{{ route('penjelasanfaktorkepribadian.edit', $data->id) }}" />
                                        <x-button-delete
                                            link="{{ route('penjelasanfaktorkepribadian.destroy', $data->id) }}" />
                                    </td>
                                </tr>
                            @empty
                                <tr>
