            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="setting-form" method="POST"
                        action="{{ route('penjelasanfaktorkepribadian.update', $data->id) }}">
                        @method('put')
                        @csrf
                                ...
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-sm-6 col-md-9">
                                        ...
                                        <input type="text" class="form-control  @error('namakarakter') is-invalid @enderror"
                                            name="namakarakter" required
                                            value="{{ old('namakarakter') ? old('namakarakter') : $data->namakarakter }}">
                                ...
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-sm-6 col-md-9">
                                        ...
                                        <textarea class="form-control" style=" min-width:500px; max-width:100%;min-height:50px;height:100%;width:100%;"
                                            ...
                                            cols="50">{{ old('pemahaman') ? old('pemahaman') : $data->pemahaman }}</textarea>
                                        @error('pemahaman')
                                            <div class="invalid-feedback"> {{ $message }}</div>
                                        @enderror
                                ...
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-sm-6 col-md-9">
                                        ...
                                        <textarea class="form-control" style=" min-width:500px; max-width:100%;min-height:50px;height:100%;width:100%;"
                                            ...
                                            cols="50">{{ old('tujuandanmanfaat') ? old('tujuandanmanfaat') : $data->tujuandanmanfaat }}</textarea>
                                ...
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-sm-6 col-md-9">
                                        ...
                                        <textarea class="form-control" style=" min-width:500px; max-width:100%;min-height:50px;height:100%;width:100%;"
                                            ...
                                            cols="50">{{ old('pembiasaansikap') ? old('pembiasaansikap') : $data->pembiasaansikap }}</textarea>
                                ...
                                {{-- <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-sm-6 col-md-9">
                                        ...
                                        <select class="form-control  @error('tipekarakter') is-invalid @enderror"
                                            ...
                                            @if (old('tipekarakter'))
                                                <option>
                                                    {{ old('tipekarakter') }}</option>
                                            @else
                                                <option>{{ $data->tipekarakter }}</option>
                                            @endif
