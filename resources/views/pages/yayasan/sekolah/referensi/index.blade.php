                ...
                <div class="card-body">
                    ...
                    <div class="d-flex bd-highlight mb-0 align-items-center">
                        ...
                        <div class="p-2 bd-highlight">
                            ...
                            <form action="{{ route('yayasan.referensi.cari') }}" method="GET">
                        ...
                        <div class="ml-auto p-2 bd-highlight">
                            {{-- <a href="{{route('yayasan.referensi.create')}}" type="submit" value="Import"
                    ...
                    {{-- <x-jsmultidel link="{{route('yayasan.referensi.multidel')}}" />
                @if ($datas->count() > 0)
                    <x-jsdatatable/>
                @endif --}}
                        ...
                        <tbody>
                            @forelse ($datas as $data)
                                <tr id="sid{{ $data->id }}">
                                    ...
                                    <x-button-edit link="{{ route('yayasan.referensi.edit',$data->id)}}" />
                                    <x-button-delete link="{{ route('yayasan.referensi.destroy',$data->id)}}" />
                                </td> --}}
                                </tr>
                            @empty
                                <tr>
