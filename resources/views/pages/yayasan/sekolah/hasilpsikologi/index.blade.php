                    ...
                    <table id="example" class="table table-striped table-bordered mt-1 table-sm" >
                        ...
                        <tbody>
                            ...
                            <tr id="sid{{ $loop->index+1 }}">
                                ...
                                <td class="text-center">
                                    <a class="btn btn-sm btn-info" href="{{route('yayasan.hasilpsikologi.deteksi_lihat',[$id->id,$data->id])}}"> Lihat Deteksi</a>
                                </td>
                                <td class="text-center">
                                    <a class="btn btn-sm btn-info" href="{{route('yayasan.hasilpsikologi.sertifikat_lihat',[$id->id,$data->id])}}"> Lihat Sertifikat</a>
