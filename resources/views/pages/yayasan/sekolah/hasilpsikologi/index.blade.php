        ...
        <div class="section-body">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <form action="{{ route('yayasan.sekolah.hasilpsikologicari', $id->id) }}" method="GET"
                        class="babeng-form">
                        <div class="row mb-2">
                            ...
                            <div class="col-6 col-md-3 col-sm-4">
                                ...
                                <select
                                    class="js-example-basic-single  form-control @error('kelas_id') is-invalid @enderror"
                    ...
                    <div class="card" id="settings-card">
                        <div class="card-header">
                            <h4>Hasil Psikologi kelas :
                                {{ $kelaspertama != null ? $kelaspertama->nama : 'Kelas tidak ditemukan' }}</h4>
                        </div>
                                ...
                                <tbody>
                                    @forelse ($datas as $data)
                                        <tr id="sid{{ $loop->index + 1 }}">
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-sm btn-info"
                                                    href="{{ route('yayasan.hasilpsikologi.sertifikat_lihat', [$id->id, $data->id]) }}">
                                                    Lihat Sertifikat</a>
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-sm btn-info"
                                                    href="{{ route('yayasan.hasilpsikologi.penjelasan_faktorkepribadian', [$id->id, $data->id]) }}">
