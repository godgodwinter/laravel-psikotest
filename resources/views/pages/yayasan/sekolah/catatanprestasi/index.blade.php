    ...
    <div class="section-body">
        ...
        <div class="row">
          ...
          <div class="col-md-9">
            ...
            <form action="{{route('yayasan.sekolah.catatanprestasicari',$id->id)}}" method="GET" class="babeng-form">
                <div class="row mb-2">
                            ...
                            <tr id="sid{{ $data->id }}">
                                    ...
                                    <td class="text-center">
                                     ...
                                     <td class="text-center">
                                        ...
                                        <a class="btn btn-sm btn-light px-3" href="{{ route('yayasan.sekolah.catatanprestasidetail',[$id->id,$data->id])}}"> {{$data->jmldata}}</a>
