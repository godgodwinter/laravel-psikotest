          ...
          <section x-data="introSectionState" class="relative min-h-screen intro">
            ...
            <div class="flex justify-center p-4 px-3 py-10">
                <div class="w-full max-w-lg">
                    ...
                    <div class="mt-8 bg-white rounded shadow shadow-drop-center">
                        <div class="py-4 text-xl tracking-wider text-center text-gray-700 border-b">
                        ...
                        >
                            ...
                            <div class="flex items-center justify-between">
                                <a class="px-4 py-2 font-bold text-white bg-blue-500 rounded hover:bg-blue-600 active:bg-blue-700 focus:outline-none focus:shadow-outline" href="#"> Submit
                                </a>
