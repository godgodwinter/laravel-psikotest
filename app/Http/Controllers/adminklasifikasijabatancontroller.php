...
class adminklasifikasijabatancontroller extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.admin.klasifikasijabatan.index',compact('pages','request','datas'));
    }
    public function create(sekolah $id)
    {
        $pages='klasifikasijabatan';

        return view('pages.admin.klasifikasijabatan.create',compact('pages'));
    }
