...
class siswacatatanpengembangandiricontroller extends Controller
{
    ...
    return view('pages.siswa.catatanpengembangandirisiswa.index', compact('pages', 'id', 'request', 'datas','kelas','data'));
    }
