...
use App\Http\Resources\bukudigitalresource;
...
class Exportbukudigital implements FromCollection, WithHeadings, ShouldAutoSize
{
    /**
    ...
    */
    ...
    ->get();
    // dd($datas);
        return bukudigitalresource::collection($datas);
    }
}
