...
class importdetailsekolah implements ToCollection,WithCalculatedFormulas
{
    ...
    */
    ...
    Fungsi::inputnilaipsikologis($sekolah_id,'KB_P',$row[2],$row[7]);
    Fungsi::inputnilaipsikologis($sekolah_id,'KBH',$row[2],$row[8]);
    Fungsi::inputnilaipsikologis($sekolah_id,'LM',$row[2],$row[9]);
    Fungsi::inputnilaipsikologis($sekolah_id,'LM_P',$row[2],$row[10]);
    Fungsi::inputnilaipsikologis($sekolah_id,'LMH',$row[2],$row[11]);
    Fungsi::inputnilaipsikologis($sekolah_id,'KS',$row[2],$row[12]);
    Fungsi::inputnilaipsikologis($sekolah_id,'KS_P',$row[2],$row[13]);
    Fungsi::inputnilaipsikologis($sekolah_id,'KSH',$row[2],$row[14]);
    Fungsi::inputnilaipsikologis($sekolah_id,'KM',$row[2],$row[15]);
    Fungsi::inputnilaipsikologis($sekolah_id,'KM_P',$row[2],$row[16]);
    Fungsi::inputnilaipsikologis($sekolah_id,'KMH',$row[2],$row[17]);
    Fungsi::inputnilaipsikologis($sekolah_id,'KK',$row[2],$row[18]);
    Fungsi::inputnilaipsikologis($sekolah_id,'KK_P',$row[2],$row[19]);
    Fungsi::inputnilaipsikologis($sekolah_id,'KKH',$row[2],$row[20]);
    Fungsi::inputnilaipsikologis($sekolah_id,'KI',$row[2],$row[21]);
    Fungsi::inputnilaipsikologis($sekolah_id,'KI_P',$row[2],$row[22]);
    Fungsi::inputnilaipsikologis($sekolah_id,'KIH',$row[2],$row[23]);
    Fungsi::inputnilaipsikologis($sekolah_id,'KA',$row[2],$row[24]);
    Fungsi::inputnilaipsikologis($sekolah_id,'KA_P',$row[2],$row[25]);
    Fungsi::inputnilaipsikologis($sekolah_id,'KAH',$row[2],$row[26]);
    Fungsi::inputnilaipsikologis($sekolah_id,'KN',$row[2],$row[27]);
    Fungsi::inputnilaipsikologis($sekolah_id,'KN_P',$row[2],$row[28]);
    Fungsi::inputnilaipsikologis($sekolah_id,'KNH',$row[2],$row[29]);
    Fungsi::inputnilaipsikologis($sekolah_id,'TTL',$row[2],$row[30]);
    Fungsi::inputnilaipsikologis($sekolah_id,'IQ',$row[2],$row[31]);
    Fungsi::inputnilaipsikologis($sekolah_id,'IQ_P',$row[2],$row[32]);
    Fungsi::inputnilaipsikologis($sekolah_id,'IQH',$row[2],$row[33]);
    Fungsi::inputnilaipsikologis($sekolah_id,'EQ_P',$row[2],$row[34]);
    Fungsi::inputnilaipsikologis($sekolah_id,'EQKET',$row[2],$row[35]);
    Fungsi::inputnilaipsikologis($sekolah_id,'SQ_P',$row[2],$row[36]);
    Fungsi::inputnilaipsikologis($sekolah_id,'SQKET',$row[2],$row[37]);
    Fungsi::inputnilaipsikologis($sekolah_id,'SCQ_P',$row[2],$row[38]);
    Fungsi::inputnilaipsikologis($sekolah_id,'SCQ_PKET',$row[2],$row[39]);
    ...
    Fungsi::inputnilaipsikologis($sekolah_id,'APLUS_P',$row[2],$row[53]);
    Fungsi::inputnilaipsikologis($sekolah_id,'APLUSKET',$row[2],$row[54]);
    Fungsi::inputnilaipsikologis($sekolah_id,'AMINUS_P',$row[2],$row[55]);
    Fungsi::inputnilaipsikologis($sekolah_id,'AMINUSKET',$row[2],$row[56]);
    Fungsi::inputnilaipsikologis($sekolah_id,'C',$row[2],$row[57]);
    Fungsi::inputnilaipsikologis($sekolah_id,'CPLUS_P',$row[2],$row[58]);
    Fungsi::inputnilaipsikologis($sekolah_id,'CPLUSKET',$row[2],$row[59]);
    Fungsi::inputnilaipsikologis($sekolah_id,'CMINUS_P',$row[2],$row[60]);
    Fungsi::inputnilaipsikologis($sekolah_id,'CMINUSKET',$row[2],$row[61]);
    Fungsi::inputnilaipsikologis($sekolah_id,'D',$row[2],$row[62]);
    Fungsi::inputnilaipsikologis($sekolah_id,'DPLUS_P',$row[2],$row[63]);
    Fungsi::inputnilaipsikologis($sekolah_id,'DPLUSKET',$row[2],$row[64]);
    Fungsi::inputnilaipsikologis($sekolah_id,'DMINUS_P',$row[2],$row[65]);
    Fungsi::inputnilaipsikologis($sekolah_id,'DMINUSKET',$row[2],$row[66]);
    Fungsi::inputnilaipsikologis($sekolah_id,'E',$row[2],$row[67]);
    Fungsi::inputnilaipsikologis($sekolah_id,'EPLUS_P',$row[2],$row[68]);
    Fungsi::inputnilaipsikologis($sekolah_id,'EPLUSKET',$row[2],$row[69]);
    Fungsi::inputnilaipsikologis($sekolah_id,'EMINUS_P',$row[2],$row[70]);
    Fungsi::inputnilaipsikologis($sekolah_id,'EMINUSKET',$row[2],$row[71]);
    Fungsi::inputnilaipsikologis($sekolah_id,'F',$row[2],$row[72]);
    Fungsi::inputnilaipsikologis($sekolah_id,'FPLUS_P',$row[2],$row[73]);
    Fungsi::inputnilaipsikologis($sekolah_id,'FPLUSKET',$row[2],$row[74]);
    Fungsi::inputnilaipsikologis($sekolah_id,'FMINUS_P',$row[2],$row[75]);
    Fungsi::inputnilaipsikologis($sekolah_id,'FMINUSKET',$row[2],$row[76]);
    Fungsi::inputnilaipsikologis($sekolah_id,'G',$row[2],$row[77]);
    Fungsi::inputnilaipsikologis($sekolah_id,'GPLUS_P',$row[2],$row[78]);
    Fungsi::inputnilaipsikologis($sekolah_id,'GPLUSKET',$row[2],$row[79]);
    Fungsi::inputnilaipsikologis($sekolah_id,'GMINUS_P',$row[2],$row[80]);
    Fungsi::inputnilaipsikologis($sekolah_id,'GMINUSKET',$row[2],$row[81]);
    Fungsi::inputnilaipsikologis($sekolah_id,'H',$row[2],$row[82]);
    Fungsi::inputnilaipsikologis($sekolah_id,'HPLUS_P',$row[2],$row[83]);
    Fungsi::inputnilaipsikologis($sekolah_id,'HPLUSKET',$row[2],$row[84]);
    Fungsi::inputnilaipsikologis($sekolah_id,'HMINUS_P',$row[2],$row[85]);
    Fungsi::inputnilaipsikologis($sekolah_id,'HMINUSKET',$row[2],$row[86]);
    Fungsi::inputnilaipsikologis($sekolah_id,'I',$row[2],$row[87]);
    Fungsi::inputnilaipsikologis($sekolah_id,'IPLUS_P',$row[2],$row[88]);
    Fungsi::inputnilaipsikologis($sekolah_id,'IPLUSKET',$row[2],$row[89]);
    Fungsi::inputnilaipsikologis($sekolah_id,'IMINUS_P',$row[2],$row[90]);
    Fungsi::inputnilaipsikologis($sekolah_id,'IMINUSKET',$row[2],$row[91]);
    Fungsi::inputnilaipsikologis($sekolah_id,'J',$row[2],$row[92]);
    Fungsi::inputnilaipsikologis($sekolah_id,'JPLUS_P',$row[2],$row[93]);
    Fungsi::inputnilaipsikologis($sekolah_id,'JPLUSKET',$row[2],$row[94]);
    Fungsi::inputnilaipsikologis($sekolah_id,'JMINUS_P',$row[2],$row[95]);
    Fungsi::inputnilaipsikologis($sekolah_id,'JMINUSKET',$row[2],$row[96]);
    Fungsi::inputnilaipsikologis($sekolah_id,'O',$row[2],$row[97]);
    Fungsi::inputnilaipsikologis($sekolah_id,'OPLUS_P',$row[2],$row[98]);
    Fungsi::inputnilaipsikologis($sekolah_id,'OPLUSKET',$row[2],$row[99]);
    Fungsi::inputnilaipsikologis($sekolah_id,'OMINUS_P',$row[2],$row[100]);
    Fungsi::inputnilaipsikologis($sekolah_id,'OMINUSKET',$row[2],$row[101]);
    Fungsi::inputnilaipsikologis($sekolah_id,'Q2',$row[2],$row[102]);
    Fungsi::inputnilaipsikologis($sekolah_id,'Q2_P',$row[2],$row[103]);
    Fungsi::inputnilaipsikologis($sekolah_id,'Q2KET',$row[2],$row[104]);
    Fungsi::inputnilaipsikologis($sekolah_id,'Q2MINUS_P',$row[2],$row[105]);
    Fungsi::inputnilaipsikologis($sekolah_id,'Q2MINUSKET',$row[2],$row[106]);
    Fungsi::inputnilaipsikologis($sekolah_id,'Q3',$row[2],$row[107]);
    Fungsi::inputnilaipsikologis($sekolah_id,'Q3_P',$row[2],$row[108]);
    Fungsi::inputnilaipsikologis($sekolah_id,'Q3KET',$row[2],$row[109]);
    Fungsi::inputnilaipsikologis($sekolah_id,'Q3MINUS_P',$row[2],$row[110]);
    Fungsi::inputnilaipsikologis($sekolah_id,'Q3MINUSKET',$row[2],$row[111]);
    Fungsi::inputnilaipsikologis($sekolah_id,'Q4',$row[2],$row[112]);
    Fungsi::inputnilaipsikologis($sekolah_id,'Q4_P',$row[2],$row[113]);
    Fungsi::inputnilaipsikologis($sekolah_id,'Q4KET',$row[2],$row[114]);
    Fungsi::inputnilaipsikologis($sekolah_id,'Q4MINUS_P',$row[2],$row[115]);
    ...
    Fungsi::inputnilaipsikologis($sekolah_id,'M1_P',$row[2],$row[128]);
    Fungsi::inputnilaipsikologis($sekolah_id,'M2',$row[2],$row[129]);
    Fungsi::inputnilaipsikologis($sekolah_id,'M2_P',$row[2],$row[130]);
    Fungsi::inputnilaipsikologis($sekolah_id,'M3',$row[2],$row[131]);
    Fungsi::inputnilaipsikologis($sekolah_id,'M3_P',$row[2],$row[132]);
