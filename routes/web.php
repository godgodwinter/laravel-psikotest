...
Route::group(['middleware' => ['auth:web', 'verified']], function () {
    ...
    Route::get('/admin/sekolah/{id}/datasiswa/generateakun', [adminsiswacontroller::class, 'generateakun'])->name('sekolah.siswa.generateakun');
    // restapi
    Route::get('/admin/api/sekolah/{id}/datasiswa/generateakun/api/getsiswa', [adminsiswacontroller::class, 'api_getsiswa'])->name('sekolah.siswa.generateakun.api.getsiswa');
    Route::post('/admin/api/sekolah/{id}/datasiswa/generateakun/api/generate/{siswa}', [adminsiswacontroller::class, 'api_generate'])->name('sekolah.siswa.generateakun.api.generate');
